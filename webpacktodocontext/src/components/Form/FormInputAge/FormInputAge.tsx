...
const FormInputAge = () => {
  ...
  return (
    ...
    >
      {(!modal && <InputNumber type="number" min={18} max={100} onChange={changeAge} placeholder="Age" />) || (
        <InputNumber type="number" value={age} min={18} max={100} onChange={changeAge} placeholder="Age" />
      )}
    </ConfigProvider>
  );
};
